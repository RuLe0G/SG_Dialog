...
{ 
    ...
    {        
        ...
        public void initDlg(TMP_Text mainText, TextData inputText)
        {
            _mainText = mainText;
            _txtData = inputText;
            SetText();
        ...
        {
            if (obj == this._mainText)
            {
                this._currentMeshInfo = this._mainText.textInfo.CopyMeshInfoVertexData();
                this._mainText.UpdateVertexData();
            }
        }
        ...
        private void SetTextColor()
        {
            ...
            _mainText.UpdateVertexData(TMP_VertexDataUpdateFlags.Colors32);
        }
        ...
        {
            TMP_TextInfo txtInfo = this._mainText.textInfo;
        ...
        private IEnumerator Wave(TMP_TextInfo txtData)
        {
            while (true)
            {
                ...
                for (int i = 0; i < txtData.meshInfo.Length; i++)
                {
                    ...
                    meshInfo.mesh.vertices = meshInfo.vertices;
                    _mainText.UpdateGeometry(meshInfo.mesh, i);
                    yield return meshInfo;
                }
